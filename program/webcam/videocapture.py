...
Pins=[4,5,6,13,19,26,12,26,14,16,15,17,19,16,18,27,22,23,24,25,20,21]
for i in Pins:
...
def giring_ka(cw,ccw,pwm_gi):
	GPIO.output(16,cw)
	GPIO.output(20,ccw)
	pwm3.ChangeDutyCycle(pwm_gi)
def giring_ki(cw,ccw,pwm_gi1):
	GPIO.output(5,cw)
	GPIO.output(6,ccw)
	pwm4.ChangeDutyCycle(pwm_gi1)
